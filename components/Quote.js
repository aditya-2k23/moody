      ...
      <div className="bg-gradient-to-br from-purple-50 to-indigo-50 dark:from-slate-900 dark:to-slate-800 rounded-2xl p-8 sm:p-10 md:p-12 shadow-lg relative overflow-hidden">
        ...
        <div className="relative z-10 text-center">
          <blockquote className="flex items-start justify-center gap-2 text-base sm:text-lg md:text-xl font-medium text-gray-800 dark:text-gray-200 leading-relaxed mb-4 px-4 italic">
            ...
            <span className="text-black dark:text-gray-100">{quote.text}</span>
        ...
        <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 flex gap-2">
          <div className="w-2 h-2 bg-purple-400 dark:bg-purple-300 rounded-full animate-bounce" />
          <div className="w-2 h-2 bg-purple-400 dark:bg-purple-300 rounded-full animate-bounce" style={{ animationDelay: '0.2s' }} />
          <div className="w-2 h-2 bg-purple-400 dark:bg-purple-300 rounded-full animate-bounce" style={{ animationDelay: '0.4s' }} />
        </div>
      </div>
    </div>
  );
