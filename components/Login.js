  ...
  return (
    <>
      ...
      >
        ...
        <p className="font-semibold font-sans text-lg">{isRegister ? "Start a new journey!" : "You are just one step away!"}</p>
        ...
        <div className="w-full max-w-[400px] mx-auto flex flex-col gap-2">
          ...
          <div className="flex items-center justify-center gap-2 text-slate-700 fugaz">
        ...
        <p className="text-center text-xs sm:text-sm text-slate-500 dark:text-slate-400 max-w-[550px] mx-auto font-sans">
          By <b>{isRegister ? "creating an account" : "signing in"}</b>, you agree to our{" "}
          <Link href="/terms" className="text-indigo-500 dark:text-indigo-400 font-semibold dark:font-normal underline hover:opacity-80">Terms of Service</Link>{" "}
          and{" "}
          <Link href="/privacy" className="text-indigo-500 dark:text-indigo-400 font-semibold dark:font-normal underline hover:opacity-80">Privacy Policy</Link>.<br />
          Your data is private and will not be shared with third parties without your consent.
        </p>

        <p className="text-center font-sans">{
          isRegister ? "Already have an account?" : "Don't have an account?"
        } <Button onClick={() => setIsRegister(!isRegister)} className="text-indigo-500 dark:text-indigo-400 hover:opacity-80" text={isRegister ? "Sign In" : "Sign Up"} normal={false} /></p>
      </div>
    </>
  )
}
