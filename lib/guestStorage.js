...
export const GUEST_DRAFT_KEY = "moody_guest_draft";
 ...
 * @param {{ mood: number|null, moodLabel: string|null, journalText: string, pendingAction?: string|null }} draft
 */
export function saveGuestDraft({ mood, moodLabel, journalText, pendingAction = null }) {
