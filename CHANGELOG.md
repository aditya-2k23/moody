...
- **Documentation**: Added prominent localized language switchers to the English and Spanish README files.

### Fixed

- **Documentation**: Fixed the Table of Contents (TOC) navigation links in `README.es-ES.md`.
